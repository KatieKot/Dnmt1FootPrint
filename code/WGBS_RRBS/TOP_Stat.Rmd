...
############################# Prideta dalis tam, kad suvienodinti su enrichment analize 
...
```{r, fig.height=9}
# Prideta tam, kad suvienodinti su enrichment 
...
Skipping some old graphs as they failed with new genomic elements.
```{r, eval=FALSE}
col_fun = colorRamp2(c(-1, 0, 1),viridis(3))

ha = HeatmapAnnotation(
    sample = colnames(frakcijos_gen),
    col = list(sample = cols_samples[-4],
