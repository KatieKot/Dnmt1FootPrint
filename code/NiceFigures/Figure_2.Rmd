...
#knitr::opts_chunk$set(res=300, fig.height=4, fig.width=4, fig.align = "center")
options(scipen=2)
...
#      scale_colour_manual(values = cols_samplesLong) +
      ...
      #facet_grid2(vars(element), vars(sample), scales = "free", independent = "all") +
      #facet_wrap(~element+sample, scales="free_y") +
      geom_vline(xintercept=which(temp$V1 == 'u100'), linetype="dotted", colour="grey") +
      geom_vline(xintercept=which(temp$V1 == 'd1'), linetype="dotted", colour="grey") 
